...
import 'package:jeeb_app/features/order/manage_order/data/data_sources/manage_order_remote_data_source.dart';

class ManageOrderRepository {
  final ManageOrderRemoteDataSource _remoteDataSource;
  final NetworkInfo _networkInfo;

  const ManageOrderRepository(
  ...
  Future<Either<Failure, bool>> rejectDelivery(
    String id,
    String reason,
  ) async {
    if (await _networkInfo.isConnected) {
